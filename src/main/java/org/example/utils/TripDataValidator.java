...
public class TripDataValidator {
    public static void validateTripRequest(TripRequestDTO tripRequest) {
        ...
        if (tripRequest.getStartDate().isBefore(tripRequest.getEndDate())) throw new IllegalArgumentException("Trip start date cannot be before end date.");
        ...
        for (TripSegmentRequestDTO segment : tripRequest.getSegments()) {
